...
const FEATURES_NAME = 'customisation';
...
const EditListingFeaturesPanel = props => {
  ...
  const customisation = publicData && publicData.customisation;
  const view = publicData && publicData.view;
  const initialValues = { customisation, view };
  ...
  return (
    <div className={classes}>
      ...
      <EditListingFeaturesForm
        ...
        onSubmit={values => {
          const { customisation = [] } = values;

          const updatedValues = {
            publicData: { customisation },
          };
